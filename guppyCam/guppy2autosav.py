...
class ThreadRunAcq(QtCore.QThread):
    ...
    def __init__(self,parent=None):
        ...
        self.LineTrigger=self.parent.LineTrigger
        self.nbImage=self.parent.nbImage
        self.conf=self.parent.visualisation.conf
        self.numTir=1
        print(self.parent.nbImage)
